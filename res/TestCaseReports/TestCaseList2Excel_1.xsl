			...
			<xsl:for-each select="./TestCase">
				<xsl:for-each select="./ElementReference">
					...
					<xsl:if test="position()=1">
						<tr height="17" style="mso-height-source:userset;height:12.75pt">
							<td rowspan="1" height="51" class="xl31" width="276" style="border-bottom:.5pt solid black;height:38.25pt;border-top:none;width:207pt">
							...
							<td rowspan="1" class="xl31" width="234" style="border-bottom:.5pt solid black;border-top:none;width:176pt">
							...
							<td rowspan="1" class="xl31" width="320" style="border-bottom:.5pt solid black;border-top:none;width:240pt">
					...
					<xsl:if test="position()&gt;1">
						...
						<tr height="17" style="mso-height-source:userset;height:12.75pt">
							...
							<td rowspan="1" class="xl31" width="234" style="border-bottom:.5pt solid black;border-top:none;width:176pt"><xsl:value-of select="key(&apos;elementNameId&apos;,$EId)"/><xsl:text>:</xsl:text>	
								<xsl:for-each select="../EqClassReference [@ElementId=$EId]">
									<xsl:variable name="EqId" select="@UniqueId"/>
									<xsl:value-of select="key(&apos;equivalenceClassValueId&apos;,$EqId)"/>,	
								</xsl:for-each>
