-injars casemakerclear.jar
-outjars casemaker.jar

-libraryjars  <java.home>/lib/rt.jar
-libraryjars lib\advancedgridheader.jar
-libraryjars lib\ostermillerutils_1_06_00.jar
-libraryjars lib\jbcl.jar
-libraryjars lib\jsr173_1.0_api.jar
-libraryjars lib\JSX2.2.5.1full.jar
-libraryjars lib\junit-4.1.jar
-libraryjars lib\license.jar
-libraryjars lib\log4j-1.2.13.jar
-libraryjars lib\smartgrid.jar
-libraryjars lib\xbean.jar
-libraryjars lib\wizard.jar
-libraryjars lib\swing-worker-1.1.jar
-libraryjars lib\jide-common.jar
-libraryjars lib\jide-grids.jar
-libraryjars lib\jide-components.jar
-libraryjars lib\jide-dialogs.jar
-libraryjars lib\jide-action.jar
-libraryjars lib\jide-dock.jar
...
-keepnames class * extends com.nexes.wizard.WizardPanelDescriptor {
    public static final String IDENTIFIER;
}

-keepnames class * extends javax.swing.plaf.ComponentUI {
    javax.swing.plaf.ComponentUI createUI(javax.swing.JComponent);
}

-keepnames class bi.view.mainframeviews.CMFrameview {
    ** *;
    % *;
    % *();
    ** *();
