/* Generated By:JavaCC: Do not edit this line. SetValuesParserTokenManager.java */
package bi.controller.tdparser.intervaltimeparser;

public class SetValuesParserTokenManager implements SetValuesParserConstants
{
...
"", null, null, null, null, null, null, "\54", "\173", "\175", "\50", "\51", 
"\44", null, null, };
...
public SetValuesParserTokenManager(SimpleCharStream stream){
   if (SimpleCharStream.staticFlag)
      throw new Error("ERROR: Cannot use a static CharStream class with a non-static lexical analyzer.");
   input_stream = stream;
}
public SetValuesParserTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
