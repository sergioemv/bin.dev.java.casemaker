/* Generated By:JavaCC: Do not edit this line. EuropeanParserTokenManager.java */
...
public class EuropeanParserTokenManager implements EuropeanParserConstants
{
...
public EuropeanParserTokenManager(SimpleCharStream stream){
   if (SimpleCharStream.staticFlag)
      throw new Error("ERROR: Cannot use a static CharStream class with a non-static lexical analyzer.");
   input_stream = stream;
}
public EuropeanParserTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
