/* Generated By:JavaCC: Do not edit this line. EuropeanParser.java */
...
public class EuropeanParser implements EuropeanParserConstants {
private int incrementValue=0;
  ...
  public EuropeanParserTokenManager token_source;
  ...
  public EuropeanParser(java.io.InputStream stream) {
     this(stream, null);
  }
  public EuropeanParser(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new EuropeanParserTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  public EuropeanParser(java.io.Reader stream) {
  ...
  public EuropeanParser(EuropeanParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  public void ReInit(EuropeanParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
