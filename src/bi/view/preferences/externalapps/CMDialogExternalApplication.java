...
public class CMDialogExternalApplication extends JDialog {
    public CMDialogExternalApplication() {
        super(CMApplication.frame, null, true);
        try {
            initGUI();
            pack();
        }
...
//hcanedo_10_08_2004_Begin
        jPanelLabelFields.setLayout(new GridLayout(3, 1));//linea modificada
...
//hcanedo_10_08_2004_Begin
		jLabelParam.setText("   " + CMMessages.getString("LABEL_APPLICATION_PARAM_COLUMN"));
        jLabelParam.setPreferredSize(new java.awt.Dimension(95, 20));
        jLabelParam.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabelParam.setMinimumSize(new java.awt.Dimension(50, 20));
        jLabelParam.setMaximumSize(new java.awt.Dimension(100, 20));
        jLabelParam.setSize(new java.awt.Dimension(150, 20));
        jLabelParam.setAlignmentY(0.5f);
        jPanelLabelParam.setLayout(new javax.swing.BoxLayout(jPanelLabelParam, javax.swing.BoxLayout.X_AXIS));
        jPanelLabelParam.setPreferredSize(new java.awt.Dimension(95, 30));
        jPanelLabelParam.add(jLabelParam);
//hcanedo_10_08_2004_End
...
//hcanedo_10_08_2004_Begin
		jPanelLabelFields.add(jPanelLabelParam);
		jPanelTextFields.setLayout(new GridLayout(3, 1));//linea modifica solo modificar
//hcanedo_10_08_2004_End
...
//hcanedo_10_08_2004_Begin
       // jTextFieldPath.setEditable(false); Linea Comentada
//hcanedo_10_08_2004_End
...
//hcanedo_10_08_2004_Begin
        jTextFieldParm.setMaximumSize(new java.awt.Dimension(280, 23));
        jTextFieldParm.setPreferredSize(new java.awt.Dimension(190, 23));
        jTextFieldParm.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        jTextFieldParm.setAlignmentY(0.04f);
        jPanelTextParm.setLayout(new javax.swing.BoxLayout(jPanelTextParm, javax.swing.BoxLayout.X_AXIS));
        jPanelTextParm.setAlignmentY(0.5f);
        jPanelTextParm.setPreferredSize(new java.awt.Dimension(245, 30));
        jPanelTextParm.add(jTextFieldParm);
//hcanedo_10_08_2004_End
...
//hcanedo_10_08_2004_begin
		jPanelTextFields.add(jPanelTextParm);
		jPanelBrowseFields.setLayout(new GridLayout(3, 1));//linea modifica solo modificar
//hcanedo_10_08_2004_End
    ...
    void jButtonOK_actionPerformed(ActionEvent e) {
        ...
        if (m_ExternalApplication == null) {
            m_ExternalApplication = new ExternalApplication();
            m_ExternalApplication.setM_FilePath(jTextFieldPath.getText());
            m_ExternalApplication.setM_Name(jTextFieldName.getText());
            //hcanedo_10_08_2004_Begin
			m_ExternalApplication.setM_Param((jTextFieldParm.getText()));
            //hcanedo_10_08_2004_End
        }
        else {
            m_ExternalApplication.setM_FilePath(jTextFieldPath.getText());
    ...
    public ExternalApplication getExternalApplication() { return m_ExternalApplication; }

    public void setExternalApplication(ExternalApplication p_ExternalApplication,boolean defaultApplication) {
        m_ExternalApplication = p_ExternalApplication;
        this.jTextFieldName.setText(m_ExternalApplication.getM_Name());
        this.jTextFieldPath.setText(m_ExternalApplication.getM_FilePath());
        //hcanedo_10_08_2004_Begin
		this.jTextFieldParm.setText(m_ExternalApplication.getM_Param());
        //hcanedo_10_08_2004_End
    ...
    private ExternalApplication m_ExternalApplication = null;
//hcanedo_10_08_2004_Begin
	JLabel jLabelParam = new JLabel();
    JTextField jTextFieldParm = new JTextField();
    JPanel jPanelTextParm = new JPanel();
    JPanel jPanelLabelParam = new JPanel();
//hcanedo_10_08_2004_End
}
