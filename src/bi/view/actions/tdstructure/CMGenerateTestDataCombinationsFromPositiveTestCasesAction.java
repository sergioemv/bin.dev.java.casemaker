...
public class CMGenerateTestDataCombinationsFromPositiveTestCasesAction extends
	...
	public CMGenerateTestDataCombinationsFromPositiveTestCasesAction(){
		super(CMMessages.getString("TDSTRUCTURE_CONTEXMENU_POSITIVE"));
		putValue(Action.SHORT_DESCRIPTION, CMMessages.getString("BUTTON_TOOLTIP_STRUCTURE_GENERATE_POSITIVE"));
	    putValue(Action.SMALL_ICON, CMAction.TESTDATA_GENERATE_TESTDATA_FROM_ALL_POSITIVE.getIcon());
	    putValue(Action.MNEMONIC_KEY,(int)CMMessages.getString("GENERATE_TEST_DATA_COMBINATIONS_FROM_THE_POSITIVE_TEST_CASES_MNEMONIC").charAt(0));
	    putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_2, Event.CTRL_MASK));
	}
	...
	public void actionPerformed(ActionEvent e) {
        ...
        if(m_gridTDStructure.existTestCase())
        {
        	if (tdStructure.getTestDataCombination().getM_TestDatas().size() > 0 ||
        		...
        		confirmation = JOptionPane.showConfirmDialog(this.m_frame,
        				...
        				CMMessages.getString("TESTDATA_TITLE_MESSAGE_DELETE_POSITIVE_TESTDATA"),
        	...
        	if (confirmation == JOptionPane.YES_OPTION) {
        		...
        		createStructure=m_gridTDStructure.insertDataTDStructureView(ce);
        		//index =m_gridTDStructure.getTDStructure().getM_StructureTestData().size()-1;

        		m_gridTDStructure.GenerateTDStructureForPositiveTestCase(createStructure,ce, intervalAmount);
        		...
        		/*this.m_frame.getM_CMUndoMediator().generatePosDeletedTDStructure(m_gridTDStructure,
        ...
        else if(confirmation ==JOptionPane.NO_OPTION)
        {
            ...
            /*this.m_frame.getM_CMUndoMediator().generatePosTDStructure(m_gridTDStructure,index,
