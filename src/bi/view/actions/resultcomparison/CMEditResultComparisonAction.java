 ...
 *
 */
public class CMEditResultComparisonAction extends AbstractAction implements
		Action {
/**
 *
 */
public CMEditResultComparisonAction() {
	  super(CMMessages.getString("LABEL_RESULT_COMPARISON_CREATE_BUTTON"));
	    // Set tool tip text
	    putValue(Action.SHORT_DESCRIPTION, CMMessages.getString("LABEL_RESULT_COMPARISON_EDIT_BUTTON"));
	     putValue(Action.SMALL_ICON, CMIcon.RESULT_EDIT.getImageIcon());
	    putValue(Action.MNEMONIC_KEY,(int)CMMessages.getString("LABEL_RESULT_COMPARISON_EDIT_BUTTON_MNEMONIC").charAt(0));
