...
public class CMPanelErrorsAssigment extends JPanel {

	private static ImageIcon errorIcon = CMIcon.ERROR_MANAGMENT.getImageIcon();  //  @jve:decl-index=0:
	...
	private void initialize() {
		...
		this.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(EtchedBorder.LOWERED), CMMessages.getString("LABEL_ASSIGNED_ERRORS"), TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, new Font("Tahoma", Font.PLAIN, 11), SystemColor.activeCaption));
