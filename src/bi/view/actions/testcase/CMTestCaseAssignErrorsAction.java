 ...
 *
 */
public class CMTestCaseAssignErrorsAction extends AbstractAction implements
		Action {
	public CMTestCaseAssignErrorsAction() {
		super(CMMessages.getString("POPUPMENU_ITEM_ASSIGN_ERRORS_TO_TEST_CASE"));
	    // Set tool tip text
	    putValue(Action.SHORT_DESCRIPTION, CMMessages.getString("BUTTON_TOOLTIP_ASSIGN_ERRORS_TO_TEST_CASE"));
	    // Set an icon
	    putValue(Action.SMALL_ICON, CMAction.TESTCASE_ASSIGN_ERRORS.getIcon());
	    putValue(Action.MNEMONIC_KEY,(int)CMMessages.getString("MENU_ITEM_ASSIGN_ERRORS_TO_TEST_CASE_MNEMONIC").charAt(0));
	 	}
	/* (non-Javadoc)
	     ...
	     TestCase selectedTestCase = TestCaseManager.getSelectedTestCase();
		    ...
		    if( selectedTestCase != null) {
		    	  ...
		    	  CMDefaultDialog dlg = new CMDefaultDialog();
				   ...
				   dlg.setJPanelContained(caseEditController.getPanel().getCMPanelErrorsAssigment());
