...
public class CMTestManagementNode{
  public CMTestManagementNode(TestObjectReference p_TestObjectReference, TestObject p_TestObject){
  ...
  public String toString() {
    return CMMessages.getString("NODE_LABEL_TEST_MANAGEMENT"); //$NON-NLS-1$
  }
