...
public class CMDialogAssignTestCaseToTestData extends JCustomDialog {
  ...
  public CMDialogAssignTestCaseToTestData(CMFrameView frame,Structure structure, Vector testCaseInTDStructure) {
    super(frame);
