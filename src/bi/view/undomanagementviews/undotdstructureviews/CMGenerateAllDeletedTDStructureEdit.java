...
public class CMGenerateAllDeletedTDStructureEdit extends CMComponentAwareEdit {
    ...
    public CMGenerateAllDeletedTDStructureEdit(CMFrameView p_CMFrameView,CMGridTDStructure p_CMGridTDStructure,TDStructure p_TDstructure, int p_Index, CMUndoMediator.FocusInfo p_FocusInfo) {
	...
	m_CMGridTDStructure.generateAllTestDataEdit();
        ...
        int m = m_CMFrameView.getM_CMUndoMediator().getM_NumberOfRedoableEditObjects()-1;
         ...
         m_CMFrameView.getPanelTestDataView().update();
        setUndoState();
        setRedoState();
    }
