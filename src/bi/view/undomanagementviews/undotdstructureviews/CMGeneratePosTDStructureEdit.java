...
public class CMGeneratePosTDStructureEdit extends CMComponentAwareEdit {
    private CMGridTDStructure m_CMGridTDStructure;
    private int m_Index;



    public CMGeneratePosTDStructureEdit(CMFrameView p_CMFrameView,CMGridTDStructure p_CMGridTDStructure, int p_Index, CMUndoMediator.FocusInfo p_FocusInfo) {
