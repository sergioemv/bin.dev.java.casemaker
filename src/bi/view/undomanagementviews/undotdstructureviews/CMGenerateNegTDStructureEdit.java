...
public class CMGenerateNegTDStructureEdit extends CMComponentAwareEdit {
    private CMGridTDStructure m_CMGridTDStructure;
    private int m_Index;



    public CMGenerateNegTDStructureEdit(CMFrameView p_CMFrameView,CMGridTDStructure p_CMGridTDStructure, int p_Index, CMUndoMediator.FocusInfo p_FocusInfo) {
