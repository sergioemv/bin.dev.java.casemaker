...
public class CMGenerateFaultyDeletedTDStructureEdit extends CMComponentAwareEdit {
    ...
    public CMGenerateFaultyDeletedTDStructureEdit(CMFrameView p_CMFrameView,CMGridTDStructure p_CMGridTDStructure,TDStructure p_TDstructure, int p_Index, CMUndoMediator.FocusInfo p_FocusInfo) {
    ...
    public void redo() throws CannotUndoException {
		...
		m_CMGridTDStructure.generateFaultyTestDataEdit();
