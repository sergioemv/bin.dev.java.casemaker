...
public class CMCancelAssignFormulainTDStructureEdit extends CMComponentAwareEdit {

    private CMGridTDStructure m_CMGridTDStructure;
    private int m_Index;
    private int m_row;
    private int m_column;
    private CMCompoundEdit m_ce;//svonborries_11032006

    /**
     * @param p_CMFrameView
     * @param p_CMGridTDStructure
     * @param p_Index
     * @param p_row
     * @param p_column
     * @param p_ce
     ...
     */
    public CMCancelAssignFormulainTDStructureEdit(CMFrameView p_CMFrameView,CMGridTDStructure p_CMGridTDStructure,
        ...
        this.m_ce=(CMCompoundEdit) p_ce;//svonborries_11032006

    }

    public void undo() throws CannotUndoException {
        super.undo();
//      svonborries_11032006_begin
        if(m_ce.isInProgress())
        	m_ce.endAll();
        m_ce.undo();
//      svonborries_11032006_end
