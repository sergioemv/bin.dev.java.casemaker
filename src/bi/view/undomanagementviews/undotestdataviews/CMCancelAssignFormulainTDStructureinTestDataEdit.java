...
public class CMCancelAssignFormulainTDStructureinTestDataEdit extends CMComponentAwareEdit {
     ...
     */
    public CMCancelAssignFormulainTDStructureinTestDataEdit(CMFrameView p_CMFrameView,CMPanelTestDataView p_CMPanelTestDataView,
        int p_IndexTestData,int p_indexStructure, int p_row, int p_column,UndoableEdit p_ce,CMUndoMediator.FocusInfo p_FocusInfo) {
