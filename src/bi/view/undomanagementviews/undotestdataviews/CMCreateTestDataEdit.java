...
public class CMCreateTestDataEdit extends CMComponentAwareEdit {
    private CMPanelTestDataView m_CMPanelTestDataView;
    private int m_IndexTestData;
	private TestData m_TestData;

    public CMCreateTestDataEdit(CMFrameView p_CMFrameView,CMPanelTestDataView p_CMPanelTestDataView,int p_IndexTestData,TestData p_TestData,CMUndoMediator.FocusInfo p_FocusInfo) {
    ...
    public void undo() throws CannotUndoException {
        super.undo();
		m_CMPanelTestDataView.undoCreateTestData(m_IndexTestData,m_TestData);
    ...
    public void redo() throws CannotRedoException {
        super.redo();
		m_CMPanelTestDataView.redoCreateTestData(m_IndexTestData,m_TestData);
		int n = m_CMFrameView.getM_CMUndoMediator().getM_NumberOfUndoableEditObjects() + 1;
		m_CMFrameView.getM_CMUndoMediator().setM_NumberOfUndoableEditObjects(n);
