 ...
 */
public class CMDeleteVariableEdit extends CMComponentAwareEdit {
   ...
   private String m_oldname;
    ...
    public CMDeleteVariableEdit(CMFrameView p_CMFrameView,CMVariables p_CMVariablesView,int p_IndexVariable, Variable p_Variable,/*String p_name, String p_description, String p_type, String p_format,String p_value,String p_oldname,String p_olddescription,String p_oldtype,String p_oldformat,TestDataFormat oldFormater, String p_oldvalue,*/CMUndoMediator.FocusInfo p_FocusInfo) {
    ...
    public void undo() throws CannotRedoException {
        super.undo();
		m_CMVariablesView.undoDeleteVariable(m_IndexVariable,m_Variable);//m_value,m_type,m_format,m_Formatter, m_description,m_name);
		int n = m_CMFrameView.getM_CMUndoMediator().getM_NumberOfUndoableEditObjects() - 1;
		m_CMFrameView.getM_CMUndoMediator().setM_NumberOfUndoableEditObjects(n);
