...
public class CMTypeDataToStructureTestDataModelEdit extends AbstractUndoableEdit {

	private StructureTestData m_structureTestData;
	private ITypeData m_typeData;
	private StructureTestData oldStructureTD;

	public CMTypeDataToStructureTestDataModelEdit(StructureTestData p_structure, ITypeData p_typeData){
	...
	public void redo() throws CannotRedoException {
		super.redo();
		this.m_structureTestData.getTypeData().addElement(m_typeData);
	...
	public void undo() throws CannotUndoException {
		super.undo();
			this.m_structureTestData.getTypeData().remove(m_typeData);
