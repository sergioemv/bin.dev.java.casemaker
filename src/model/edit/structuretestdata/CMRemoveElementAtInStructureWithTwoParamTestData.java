...
public class CMRemoveElementAtInStructureWithTwoParamTestData extends
	...
	public CMRemoveElementAtInStructureWithTwoParamTestData(StructureTestData p_structureTestData, int p_row){
		m_structure = p_structureTestData;
		m_typeData = (ITypeData) p_structureTestData.getTypeData().elementAt(p_row);
		m_row= p_row;
	}
