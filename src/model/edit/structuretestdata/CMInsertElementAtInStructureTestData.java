...
public class CMInsertElementAtInStructureTestData extends AbstractUndoableEdit {

	private ITypeData m_typeData;
	private StructureTestData m_structure;
	private int m_row;

	public CMInsertElementAtInStructureTestData(ITypeData p_typeData, StructureTestData p_structureTestData, int p_row){
