...
public class CMAtanFormula extends CMAbstractFormula {


	
	public Object calculate() throws Exception {
        	Number param1 = (Number) getCalculatedParameter(CMFormulaParameter.NUMBER);
            Number result = Math.atan(param1.doubleValue());
	...
	public CMFormulas getFormulaEnum() {
		super.setFormulaEnum(CMFormulas.ATAN);
		return CMFormulas.ATAN;
	}
