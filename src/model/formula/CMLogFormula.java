...
public class CMLogFormula extends CMAbstractFormula {
	...
	public Object calculate()  throws Exception{
        	...
        	Number param2 = (Number) getCalculatedParameter(CMFormulaParameter.BASE);
            Number result = (Math.log(param1.doubleValue()) / (Math.log(param2.doubleValue())));
	...
	public CMFormulas getFormulaEnum() {
		super.setFormulaEnum(CMFormulas.LOG);
		return CMFormulas.LOG;
	}
