...
public class CMACosHypFormula extends CMAbstractFormula {

	
	public Object calculate() throws Exception {
        	Number param1 = (Number) getCalculatedParameter(CMFormulaParameter.NUMBER);
            Number result = CMNumberUtils.aCosHyp(param1.doubleValue());
	...
	public CMFormulas getFormulaEnum() {
		super.setFormulaEnum(CMFormulas.ACOSHYP);
		return CMFormulas.ACOSHYP;
	}
