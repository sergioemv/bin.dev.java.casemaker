...
public class CMMinFormula extends CMAbstractFormula {
	...
	public Object calculate()  throws Exception{
            ...
            return (Number) Math.min(param1.doubleValue(), param2.doubleValue());
	}
	...
	public CMFormulas getFormulaEnum() {
		super.setFormulaEnum(CMFormulas.MIN);
		return CMFormulas.MIN;
	}
