 ...
 *
 */
public class CMGFormula extends CMAbstractFormula {
	...
	public Object calculate()  throws Exception{
        //return (Number) Double.parseDouble("6.67300E-11");
		return (String)BusinessRules.FORMULAS_CATEGORY_CONSTANTS_G();
	}
	...
	public CMFormulas getFormulaEnum() {
		super.setFormulaEnum(CMFormulas.G);
		return CMFormulas.G;
	}
