...
public class CMTanHypFormula extends CMAbstractFormula {
	...
	public Object calculate()  throws Exception{
            ...
            Number result = CMNumberUtils.tanHyp(param1.doubleValue());
	...
	public CMFormulas getFormulaEnum() {
		super.setFormulaEnum(CMFormulas.TANHYP);
		return CMFormulas.TANHYP;
	}
