...
public class CMLog10Formula extends CMAbstractFormula {
	...
	public Object calculate()  throws Exception{
            ...
            Number result = 0.434294 * Math.log(param1.doubleValue());
	...
	public CMFormulas getFormulaEnum() {
		super.setFormulaEnum(CMFormulas.LOG10);
		return CMFormulas.LOG10;
	}
