...
public class CMCosHypFormula extends CMAbstractFormula {


	
	public Object calculate() throws Exception {
        	Number param1 = (Number) getCalculatedParameter(CMFormulaParameter.NUMBER);
            Number result = CMNumberUtils.cosHyp(param1.doubleValue());
	...
	public CMFormulas getFormulaEnum() {
		super.setFormulaEnum(CMFormulas.COSHYP);
		return CMFormulas.COSHYP;
	}
