...
public class CMSqrtFormula extends CMAbstractFormula {
	...
	public Object calculate()  throws Exception{
            ...
            Number result = Math.sqrt(param1.doubleValue());
	...
	public CMFormulas getFormulaEnum() {
		super.setFormulaEnum(CMFormulas.SQRT);
		return CMFormulas.SQRT;
	}
