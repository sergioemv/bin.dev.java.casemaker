 ...
 *
 */
public class CMDifferenceFormula extends CMAbstractFormula {
	...
	public Object calculate() throws Exception {
    	  ...
    	  return (Number)(param1.doubleValue() - param2.doubleValue());
	}
	...
	public CMFormulas getFormulaEnum() {
		super.setFormulaEnum(CMFormulas.DIFFERENCE);
		return CMFormulas.DIFFERENCE;
	}
